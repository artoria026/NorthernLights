...
export function Accounts() {
  ...
  return (
    <div>
      <ViewHeader icon={<Building2 />} title="Cuentas" help={<AccountsHelp />} section={HEADER_SECTIONS.diario} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 items-stretch">
        <div className="bg-card border border-border rounded-md p-[18px] flex flex-col">
        ...
        <div className="bg-card border border-border rounded-md p-5 min-w-0">
          {selectedAccount ? (
            <>
