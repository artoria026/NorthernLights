...
/** Icono de novedades (al lado del tema/campana en AppSidebar) + el modal
 * con el detalle de cada release y el formulario de feedback. Si el usuario
 * todavia no vio la version mas reciente (`user.last_seen_changelog_version`
 * desactualizado o null), se auto-abre una vez al cargar -- al cerrarlo (X,
 * click afuera, o el boton "Entendido") se marca como visto via
 * useUpdateSettings, mismo patron que el tema: viaja con la cuenta, no
